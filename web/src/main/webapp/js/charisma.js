$(document).ready(function () {
    ...
    var
        History = window.History, State = History.getState(), $log = $('#log');
    History.Adapter.bind(window, 'statechange', function () {
        var State = History.getState();
        $.ajax({
            url: State.url, success: function (msg) {
    ...
    $('.accordion > a').click(function (e) {
        ...
        var $li = $(this).parent();
        if ($ul.is(':visible'))$li.removeClass('active'); else $li.addClass('active');
        $ul.slideToggle();
    });
...
function docReady() {
    ...
    $('ul.gallery li').hover(function () {
        ...
        $(this).append('<div class="well gallery-controls">' + '<p><a href="#" class="gallery-edit btn"><i class="glyphicon glyphicon-edit"></i></a> <a href="#" class="gallery-delete btn"><i class="glyphicon glyphicon-remove"></i></a></p>' + '</div>');
    ...
    /*$('.datatable').dataTable({"sDom":"<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'i><'col-md-12 center-block'p>>","sPaginationType":"bootstrap","oLanguage":{"sLengthMenu":"_MENU_ records per page"}});*/
    ...
    $('.btn-minimize').click(function (e) {
        ...
        if ($target.is(':visible'))$('i', $(this)).removeClass('glyphicon-chevron-up').addClass('glyphicon-chevron-down'); else $('i', $(this)).removeClass('glyphicon-chevron-down').addClass('glyphicon-chevron-up');
        $target.slideToggle();
    });
    ...
    $('#calendar').fullCalendar({
        ...
        events: [{title: 'All Day Event', start: '2014-06-01'}, {
            title: 'Long Event',
            start: '2014-06-07',
            end: '2014-06-10'
